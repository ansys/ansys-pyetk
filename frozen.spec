...
OUT_PATH = 'ansys_pyetk'
APP_NAME = 'ansys_pyetk' if is_linux else 'Electronic Transformer Toolkit'
SRC_PATH = 'src/ansys/aedt/toolkits/electronic_transformer'

CODE_PATH = os.path.join(THIS_PATH, SRC_PATH)
...
# Package example json files with installation
