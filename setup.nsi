; NSIS script for Electronic Transformer toolKit (PyETK) installer
...
Section "${PRODUCT_NAME}" SEC01
  ...
  ; Copy the files from the dist\${APP_OUT_PATH} directory
  File /r "dist\${APP_OUT_PATH}\*"
...
Icon "dist\${APP_OUT_PATH}\_internal\assets\splash_icon.ico"
