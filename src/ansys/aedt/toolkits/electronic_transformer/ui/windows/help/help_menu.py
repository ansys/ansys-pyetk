...
<p>
Except for the GUI components, your use of this software is governed by the Apache-2.0 License.
...
class HelpMenu(object):
    ...
    def setup(self):
        ...
        row_returns = self.ui.add_n_buttons(
            self.help_column_vertical_layout,
            num_buttons=1,
            height=40,
            width=[200],
            text=["About"],
    ...
    def report_issue(self):
        """Access the PyAEDT Template Toolkit issues tracker."""
