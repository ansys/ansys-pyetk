...
class Ui_Geometry(object):
    ...
    def retranslateUi(self, Geometry):
        ...
        self.label_14.setText(QCoreApplication.translate("Geometry", u"Winding Size", None))
        self.label_16.setText(QCoreApplication.translate("Geometry", u"Core Window", None))
