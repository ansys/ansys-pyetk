...
################################################################################
## Form generated from reading UI file 'main_pageSGjiql.ui'
##
...
class Ui_Geometry(object):
    def setupUi(self, Geometry):
        ...
        self.groupBox_3 = QGroupBox(Geometry)
        self.groupBox_3.setObjectName(u"groupBox_3")
        self.groupBox_3.setMinimumSize(QSize(530, 70))
        self.groupBox_3.setMaximumSize(QSize(530, 70))
        self.gridLayout_9 = QGridLayout(self.groupBox_3)
        self.gridLayout_9.setObjectName(u"gridLayout_9")
        self.gridLayout_8 = QGridLayout()
        self.gridLayout_8.setObjectName(u"gridLayout_8")
        self.gridLayout_8.setContentsMargins(6, 6, 6, -1)
        self.next_example_button = QPushButton(self.groupBox_3)
        self.next_example_button.setObjectName(u"next_example_button")
        self.next_example_button.setMinimumSize(QSize(40, 30))
        self.next_example_button.setMaximumSize(QSize(40, 30))

        self.gridLayout_8.addWidget(self.next_example_button, 0, 3, 1, 1)

        self.example_name = QLineEdit(self.groupBox_3)
        self.example_name.setObjectName(u"example_name")
        self.example_name.setMinimumSize(QSize(200, 0))

        self.gridLayout_8.addWidget(self.example_name, 0, 5, 1, 1)
        ...
        self.previous_example_button = QPushButton(self.groupBox_3)
        self.previous_example_button.setObjectName(u"previous_example_button")
        self.previous_example_button.setMinimumSize(QSize(40, 30))
        self.previous_example_button.setMaximumSize(QSize(40, 30))

        self.gridLayout_8.addWidget(self.previous_example_button, 0, 2, 1, 1)

        self.open_etk = QPushButton(self.groupBox_3)
        self.open_etk.setObjectName(u"open_etk")
        sizePolicy1 = QSizePolicy(QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Fixed)
        sizePolicy1.setHorizontalStretch(0)
        sizePolicy1.setVerticalStretch(0)
        sizePolicy1.setHeightForWidth(self.open_etk.sizePolicy().hasHeightForWidth())
        self.open_etk.setSizePolicy(sizePolicy1)
        self.open_etk.setMinimumSize(QSize(120, 30))
        self.open_etk.setMaximumSize(QSize(120, 30))

        self.gridLayout_8.addWidget(self.open_etk, 0, 0, 1, 1)
        ...
        self.groupBox_4.setMinimumSize(QSize(560, 0))
        self.groupBox_4.setMaximumSize(QSize(530, 16777215))
        ...
        self.gridLayout.addWidget(self.D_7_label, 11, 0, 1, 1)

        self.model_combo = QComboBox(self.groupBox_4)
        self.model_combo.setObjectName(u"model_combo")
        self.model_combo.setMaximumSize(QSize(110, 16777215))

        self.gridLayout.addWidget(self.model_combo, 2, 1, 1, 3)

        self.type_combo = QComboBox(self.groupBox_4)
        self.type_combo.setObjectName(u"type_combo")
        self.type_combo.setMaximumSize(QSize(110, 16777215))

        self.gridLayout.addWidget(self.type_combo, 1, 1, 1, 3)
        ...
        sizePolicy3.setHeightForWidth(self.material_combo.sizePolicy().hasHeightForWidth())
        self.material_combo.setSizePolicy(sizePolicy3)
        self.material_combo.setMaximumSize(QSize(110, 16777215))

        self.gridLayout.addWidget(self.material_combo, 3, 1, 1, 3)

        self.core_airgap_size = QLabel(self.groupBox_4)
        self.core_airgap_size.setObjectName(u"core_airgap_size")

        self.gridLayout.addWidget(self.core_airgap_size, 15, 0, 1, 1)
        ...
        sizePolicy4.setHeightForWidth(self.airgap_value.sizePolicy().hasHeightForWidth())
        self.airgap_value.setSizePolicy(sizePolicy4)
        self.airgap_value.setMaximumSize(QSize(50, 16777215))

        self.gridLayout.addWidget(self.airgap_value, 15, 1, 1, 1)

        self.verticalSpacer_4 = QSpacerItem(20, 20, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed)

        self.gridLayout.addItem(self.verticalSpacer_4, 11, 3, 1, 1)

        self.D_6_label = QLabel(self.groupBox_4)
        self.D_6_label.setObjectName(u"D_6_label")

        self.gridLayout.addWidget(self.D_6_label, 10, 0, 1, 1)
        ...
        self.D_4.setMaximumSize(QSize(50, 16777215))

        self.gridLayout.addWidget(self.D_4, 8, 1, 1, 1)

        self.D_2 = QLineEdit(self.groupBox_4)
        self.D_2.setObjectName(u"D_2")
        self.D_2.setMaximumSize(QSize(50, 16777215))

        self.gridLayout.addWidget(self.D_2, 6, 1, 1, 1)

        self.D_3_label = QLabel(self.groupBox_4)
        self.D_3_label.setObjectName(u"D_3_label")

        self.gridLayout.addWidget(self.D_3_label, 7, 0, 1, 1)

        self.verticalSpacer_9 = QSpacerItem(20, 22, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed)

        self.gridLayout.addItem(self.verticalSpacer_9, 14, 3, 1, 1)

        self.D_5_label = QLabel(self.groupBox_4)
        self.D_5_label.setObjectName(u"D_5_label")

        self.gridLayout.addWidget(self.D_5_label, 9, 0, 1, 1)
        ...
        self.D_6.setMaximumSize(QSize(50, 16777215))

        self.gridLayout.addWidget(self.D_6, 10, 1, 1, 1)

        self.D_2_label = QLabel(self.groupBox_4)
        self.D_2_label.setObjectName(u"D_2_label")

        self.gridLayout.addWidget(self.D_2_label, 6, 0, 1, 1)

        self.verticalSpacer_3 = QSpacerItem(20, 20, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed)

        self.gridLayout.addItem(self.verticalSpacer_3, 10, 3, 1, 1)
        ...
        self.verticalSpacer_8 = QSpacerItem(20, 22, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed)

        self.gridLayout.addItem(self.verticalSpacer_8, 15, 3, 1, 1)
        ...
        sizePolicy5.setHeightForWidth(self.supplier_combo.sizePolicy().hasHeightForWidth())
        self.supplier_combo.setSizePolicy(sizePolicy5)
        self.supplier_combo.setMaximumSize(QSize(110, 16777215))

        self.gridLayout.addWidget(self.supplier_combo, 0, 1, 1, 3)

        self.D_3 = QLineEdit(self.groupBox_4)
        self.D_3.setObjectName(u"D_3")
        self.D_3.setMaximumSize(QSize(50, 16777215))

        self.gridLayout.addWidget(self.D_3, 7, 1, 1, 1)

        self.D_7 = QLineEdit(self.groupBox_4)
        self.D_7.setObjectName(u"D_7")
        self.D_7.setMaximumSize(QSize(50, 16777215))

        self.gridLayout.addWidget(self.D_7, 11, 1, 1, 1)

        self.D_1 = QLineEdit(self.groupBox_4)
        self.D_1.setObjectName(u"D_1")
        sizePolicy1.setHeightForWidth(self.D_1.sizePolicy().hasHeightForWidth())
        self.D_1.setSizePolicy(sizePolicy1)
        self.D_1.setMaximumSize(QSize(50, 16777215))

        self.gridLayout.addWidget(self.D_1, 5, 1, 1, 1)

        self.verticalSpacer_5 = QSpacerItem(20, 20, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed)

        self.gridLayout.addItem(self.verticalSpacer_5, 12, 3, 1, 1)
        ...
        self.gridLayout.addItem(self.verticalSpacer_6, 13, 3, 1, 1)

        self.D_1_label = QLabel(self.groupBox_4)
        self.D_1_label.setObjectName(u"D_1_label")

        self.gridLayout.addWidget(self.D_1_label, 5, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.custom_core_checkbox, 4, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.airgap_combo, 14, 1, 1, 2)
        ...
        sizePolicy1.setHeightForWidth(self.core_image.sizePolicy().hasHeightForWidth())
        self.core_image.setSizePolicy(sizePolicy1)
        self.core_image.setMinimumSize(QSize(310, 370))

        self.horizontalLayout_2.addWidget(self.core_image)

        self.verticalSpacer_7 = QSpacerItem(20, 516, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed)

        self.horizontalLayout_2.addItem(self.verticalSpacer_7)
        ...
        self.bobbin_groupbox.setMinimumSize(QSize(261, 130))
        self.bobbin_groupbox.setMaximumSize(QSize(261, 120))
        ...
        sizePolicy6.setHeightForWidth(self.bobbin_label.sizePolicy().hasHeightForWidth())
        self.bobbin_label.setSizePolicy(sizePolicy6)
        ...
        sizePolicy1.setHeightForWidth(self.bobbin_board_thickness.sizePolicy().hasHeightForWidth())
        self.bobbin_board_thickness.setSizePolicy(sizePolicy1)
        self.bobbin_board_thickness.setMinimumSize(QSize(50, 0))
        self.bobbin_board_thickness.setMaximumSize(QSize(65, 16777215))
        ...
        sizePolicy1.setHeightForWidth(self.top_margin.sizePolicy().hasHeightForWidth())
        self.top_margin.setSizePolicy(sizePolicy1)
        self.top_margin.setMinimumSize(QSize(50, 0))
        self.top_margin.setMaximumSize(QSize(65, 16777215))
        ...
        sizePolicy1.setHeightForWidth(self.side_margin.sizePolicy().hasHeightForWidth())
        self.side_margin.setSizePolicy(sizePolicy1)
        self.side_margin.setMinimumSize(QSize(50, 0))
        self.side_margin.setMaximumSize(QSize(65, 16777215))
        ...
        self.groupBox.setMinimumSize(QSize(261, 130))
        self.groupBox.setMaximumSize(QSize(261, 150))
        ...
        sizePolicy1.setHeightForWidth(self.adaptive_frequency.sizePolicy().hasHeightForWidth())
        self.adaptive_frequency.setSizePolicy(sizePolicy1)
        self.adaptive_frequency.setMinimumSize(QSize(50, 0))
        self.adaptive_frequency.setMaximumSize(QSize(65, 16777215))
        ...
        self.excitation_value.setMaximumSize(QSize(65, 16777215))
        ...
        self.excitation_combo.setMinimumSize(QSize(80, 0))
        self.excitation_combo.setMaximumSize(QSize(80, 16777215))
        ...
        self.groupBox_2.setMinimumSize(QSize(600, 750))
        self.gridLayoutWidget = QWidget(self.groupBox_2)
        self.gridLayoutWidget.setObjectName(u"gridLayoutWidget")
        self.gridLayoutWidget.setGeometry(QRect(10, 20, 796, 686))
        self.gridLayout_5 = QGridLayout(self.gridLayoutWidget)
        self.gridLayout_5.setObjectName(u"gridLayout_5")
        self.gridLayout_5.setContentsMargins(0, 0, 0, 0)
        self.cond_material = QComboBox(self.gridLayoutWidget)
        self.cond_material.addItem("")
        self.cond_material.addItem("")
        self.cond_material.setObjectName(u"cond_material")
        sizePolicy1.setHeightForWidth(self.cond_material.sizePolicy().hasHeightForWidth())
        self.cond_material.setSizePolicy(sizePolicy1)
        ...
        self.ungroup = QPushButton(self.gridLayoutWidget)
        self.ungroup.setObjectName(u"ungroup")
        self.ungroup.setMinimumSize(QSize(91, 25))
        self.ungroup.setMaximumSize(QSize(90, 16777215))

        self.gridLayout_5.addWidget(self.ungroup, 14, 0, 1, 1)

        self.build_combo = QComboBox(self.gridLayoutWidget)
        ...
        self.add_layer = QPushButton(self.gridLayoutWidget)
        ...
        self.layer_spacing = QLineEdit(self.gridLayoutWidget)
        ...
        self.gridLayout_5.addItem(self.verticalSpacer_11, 15, 0, 1, 1)

        self.verticalSpacer_12 = QSpacerItem(20, 20, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed)

        self.gridLayout_5.addItem(self.verticalSpacer_12, 16, 0, 1, 1)

        self.connections_tree_widget = QTreeWidget(self.gridLayoutWidget)
        ...
        self.connections_tree_widget.setMaximumSize(QSize(450, 16777215))

        self.gridLayout_5.addWidget(self.connections_tree_widget, 10, 1, 6, 8)
        ...
        self.gridLayout_5.addItem(self.verticalSpacer_15, 13, 0, 1, 1)
        ...
        self.cond_type = QComboBox(self.gridLayoutWidget)
        self.cond_type.addItem("")
        self.cond_type.addItem("")
        self.cond_type.setObjectName(u"cond_type")
        sizePolicy1.setHeightForWidth(self.cond_type.sizePolicy().hasHeightForWidth())
        self.cond_type.setSizePolicy(sizePolicy1)
        ...
        self.series = QPushButton(self.gridLayoutWidget)
        self.series.setObjectName(u"series")
        self.series.setMinimumSize(QSize(0, 25))
        self.series.setMaximumSize(QSize(90, 25))

        self.gridLayout_5.addWidget(self.series, 11, 0, 1, 1)

        self.parallel = QPushButton(self.gridLayoutWidget)
        self.parallel.setObjectName(u"parallel")
        self.parallel.setMinimumSize(QSize(0, 25))
        self.parallel.setMaximumSize(QSize(90, 25))

        self.gridLayout_5.addWidget(self.parallel, 12, 0, 1, 1)

        self.winding_tree_widget = QTreeWidget(self.gridLayoutWidget)
        ...
        sizePolicy1.setHeightForWidth(self.winding_tree_widget.sizePolicy().hasHeightForWidth())
        self.winding_tree_widget.setSizePolicy(sizePolicy1)
        self.winding_tree_widget.setMinimumSize(QSize(0, 300))
        self.winding_tree_widget.setMaximumSize(QSize(450, 16777215))

        self.gridLayout_5.addWidget(self.winding_tree_widget, 3, 1, 6, 8)
        ...
        self.remove = QPushButton(self.gridLayoutWidget)
        self.remove.setObjectName(u"remove")
        self.remove.setMinimumSize(QSize(0, 25))
        self.remove.setMaximumSize(QSize(90, 16777215))

        self.gridLayout_5.addWidget(self.remove, 6, 0, 1, 1)

        self.verticalSpacer_13 = QSpacerItem(20, 20, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed)
        ...
        self.add_winding = QPushButton(self.gridLayoutWidget)
        ...
        self.winding_label = QLabel(self.gridLayoutWidget)
        self.winding_label.setObjectName(u"winding_label")

        self.gridLayout_5.addWidget(self.winding_label, 9, 2, 1, 1)
        ...
        self.groupBox_5.setMinimumSize(QSize(600, 80))
        ...
        self.New_button.setMinimumSize(QSize(120, 30))
        self.New_button.setMaximumSize(QSize(120, 30))

        self.gridLayout_7.addWidget(self.New_button, 0, 3, 1, 1)

        self.save_etk = QPushButton(self.groupBox_5)
        self.save_etk.setObjectName(u"save_etk")
        self.save_etk.setMinimumSize(QSize(120, 30))
        self.save_etk.setMaximumSize(QSize(120, 30))

        self.gridLayout_7.addWidget(self.save_etk, 0, 1, 1, 1)
        ...
        self.gridLayout_10.addLayout(self.gridLayout_7, 0, 2, 1, 1)
    ...
    def retranslateUi(self, Geometry):
        ...
        self.groupBox_3.setTitle(QCoreApplication.translate("Geometry", u"Open ETK or Load ETK Examples", None))
        self.next_example_button.setText(QCoreApplication.translate("Geometry", u">", None))
        self.label_13.setText(QCoreApplication.translate("Geometry", u"ETK Example", None))
        ...
        self.label_12.setText(QCoreApplication.translate("Geometry", u"Excitation Strategy", None))
        ...
        self.remove.setText(QCoreApplication.translate("Geometry", u"Remove", None))
